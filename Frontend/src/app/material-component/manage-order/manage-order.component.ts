...
export class ManageOrderComponent implements OnInit {
  ...
  add(){
    ...
    if(productName === undefined){
      ...
      this.dataSource.push({id: formData.product.id, name: formData.product.name, category: formData.category.name, quantity: formData.quantity, price: formData.price, 
